...
const LevelScript level_wf_entry[] = {
	...
	LOAD_YAY0(0x0A, _beta_wf_skybox_yay0SegmentRomStart, _beta_wf_skybox_yay0SegmentRomEnd), 
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE_GROUNDS, 0x02, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_CASTLE_GROUNDS, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, 0, 3443, 682, 4787),
		OBJECT(MODEL_NONE, 3202, 200, 4787, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_BREAKABLE_BOX, 1013, 3697, 2105, 0, 90, 0, (0x01 << 16), bhvBreakableBox),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3009, 42, 3965, 0, 90, 0, (0x01 << 16), bhvSignOnWall),
		OBJECT(MODEL_STAR, 812, 3793, 2105, 0, 90, 0, (0x00 << 24), bhvStar),
		OBJECT(MODEL_STAR, -1361, 1176, 2891, 0, 90, 0, (0x01 << 24), bhvStar),
		OBJECT(MODEL_STAR, 793, 5986, 2310, 0, 90, 0, (0x02 << 24), bhvStar),
